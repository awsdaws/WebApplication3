...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="gender" DataValueField="gender">
        </asp:DropDownList>
        <p>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="grade" DataValueField="grade">
        </asp:DropDownList>
        <p>
